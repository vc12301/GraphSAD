...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='030_UCR_Anomaly_DISTORTEDInternalBleeding19_3000_4187_4197.txt', help='data file')
    ...
    parser.add_argument('--default_order', type=int, default=3, help='xxx')

    parser.add_argument('--input_dim', type=int, default=1, help='time series dimension')
    parser.add_argument('--stride_factor', type=float, default=0.25, help='ratio of stride length to period length')
    parser.add_argument('--reference_factor', type=float, default=1., help='ratio of reference length to period length')
    parser.add_argument('--k', type=int, default=5, help='the number of knn neighbours in semantic graph')

    # model settings
    parser.add_argument('--lamb', type=float, default=1.0, help='the weight of the autoencoder regularization')
